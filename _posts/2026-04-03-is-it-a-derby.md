...
[Is It A Derby?](https://typedformiles.github.io/isitaderby/) lets you pick any two English football clubs from a database of 151 across 6 tiers of the pyramid and gives you a score from 0 to 100. It's fully static, no backend, runs on GitHub Pages.
...
[Try it out](https://typedformiles.github.io/isitaderby/) and settle some arguments. [Source code on GitHub](https://github.com/typedformiles/isitaderby).
